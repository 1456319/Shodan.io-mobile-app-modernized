...
export class HomePage {
  ...
  getQueries() {
    this.api.getQueries().then((res) => {
      // SECURITY: Removed console.log that was leaking search queries
      this.queries = res['matches']
    });
  }

  changeQuery(item) {
    // SECURITY: Removed console.log that was leaking search query details
    this.query = item.query;
  }

  getMoreQueries(infiniteScroll) {
    this.api.getMoreQueries().then((res) => {
      // SECURITY: Removed console.log that was leaking search query results
