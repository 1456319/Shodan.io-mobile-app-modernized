...
export class AlertsPage implements OnInit {
  ...
  getAlerts() {
    this.api.getNetworkAlerts().then((alerts) => {
      // SECURITY: Removed console.log that was leaking the network alerts data in plain text
      this.alerts = alerts;
    })
  }
      ...
      buttons: [
        {
          ...
          handler: (data) => {
            ...
            this.api.createNewNetworkAlert(alert).then((value) => {
              // SECURITY: Removed console.log that was leaking the newly created network alert data in plain text
