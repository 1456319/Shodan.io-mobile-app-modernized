...
## 2026-05-09 - [CRITICAL] Fix Sensitive Data Leak in Console Logs
**Vulnerability:** The application was logging sensitive user search history, bookmarks, and network alert data to the browser console in `history.page.ts`, `my-searches.page.ts`, and `alerts.page.ts`.
...
**Prevention:** Establish a strict policy against logging sensitive data. Use safe logging abstractions that sanitize data before logging.
