...
**Learning:** Developers often use `console.log` for debugging during development and forget to remove them before production, leading to unintentional information leakage of user-specific data.
**Prevention:** Establish a strict policy against logging sensitive user data. Use safe logging abstractions that sanitize data.
