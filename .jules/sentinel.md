...
## 2026-03-27 - [CRITICAL] Fix Sensitive Data Leak in Console Logs
**Vulnerability:** The application was logging the user's full search history to the browser console (console.log(this.searches);) in src/app/history/history.page.ts.
**Learning:** Developers often use console.log for debugging during development and forget to remove them before production, leading to unintentional information leakage of user's personal activity history.
