...
**Vulnerability:** The application was logging sensitive user search queries and raw API search results directly to the console in `src/app/search-results/search-results.page.ts`.
**Learning:** Developers often use `console.log` for debugging during development and forget to remove them, leading to unintentional information leakage of user search history and Shodan results.
