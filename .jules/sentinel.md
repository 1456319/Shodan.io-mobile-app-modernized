...
## 2026-06-21 - [CRITICAL] Fix Sensitive Data Leak in Console Logs
...
**Learning:** Even internal feature state like search history can contain sensitive user information and should not be logged to the console.
